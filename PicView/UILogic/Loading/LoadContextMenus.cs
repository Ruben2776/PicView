...
namespace PicView.UILogic.Loading
{
    internal static class LoadContextMenus
    {
        internal static void AddContextMenus()
        {
            ...
            {
                InputGestureText = "T",
                Header = Application.Current.Resources["ChangeBg"],
                ToolTip = Application.Current.Resources["ChangeBgTooltip"],
                Foreground = (SolidColorBrush)Application.Current.Resources["MainColorBrush"]
            };

            transcm.MouseEnter += (_, _) => transcm.Foreground = new SolidColorBrush(Colors.White);
            transcm.MouseLeave += (_, _) => transcm.Foreground = (SolidColorBrush)Application.Current.Resources["MainColorBrush"];
            ...
            {
                Header = Application.Current.Resources["SettingsWindow"],
            ...
            settingscmShortcut.MouseLeave += (_, _) => settingscmShortcut.Foreground = (SolidColorBrush)Application.Current.Resources["MainColorBrush"];
