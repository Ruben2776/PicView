...
PicView has a neat looking interface, where you can swap between viewing images as a gallery or a standard simple interface. It is designed to quickly and efficiently browses through images supporting all common file formats, including `.heic`, `.psd`, `.png`, `.jpg` & RAW camera image files.
