...
internal static class OpenSave
{
    ...
    internal const string FilterFiles =
        "*|*.bmp;*.jpg;*.png;*.tif;*.tiff;*.gif;*.ico;*.jpeg;*.webp;*.qoi;*.psd;*.psb;*.xcf;*.avif;*.jp2;*.hdr;*.heif;*.heif;*.pcd;*.wbmd;*.thm;*.pcd;*.pcx;"
        + "|jpg|*.jpg;*.jpeg;"                                                                                              // JPG
        + "|PNG|*.png;"                                                                                                     // PNG
        + "|gif|*.gif;"                                                                                                     // GIF
        + "|TIFF|*.tif;*.tiff;"                                                                                             // TIF
        ...
        + "|Camera files|*.orf;*.cr2;*.crw;*.dng;*.raf;*.ppm;*.raw;*.mrw;*.nef;*.pef;*.3xf;*.arw;*.pcd;*.pcx;";             // Camera files
