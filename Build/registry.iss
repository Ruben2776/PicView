...
Root: HKCR; Subkey: "*\shell\PicView"; ValueType: string; ValueName: "Icon"; ValueData: """{app}\{#MyAppExeName}"",0"; Flags: uninsdeletekey; Tasks: "openwith"
...
Root: HKCR; Subkey: "Directory\Background\shell\PicView"; ValueType: string; ValueName: "Icon"; ValueData: """{app}\{#MyAppExeName}"",0"; Flags: uninsdeletekey; Tasks: "browsefolder"
...
Root: HKCR; Subkey: "Directory\shell\PicView"; ValueType: string; ValueName: "Icon"; ValueData: """{app}\{#MyAppExeName}"",0"; Flags: uninsdeletekey; Tasks: "browsefolder"
